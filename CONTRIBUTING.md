# Contributing to JobClaw (Virgil)

Thanks for your interest in contributing! JobClaw is built with Claude Code, and you can use it for development too.
...
- Report bugs via [Issues](https://github.com/ZRosserMcIntosh/jobclaw/issues)
...
- [Open an issue](https://github.com/ZRosserMcIntosh/jobclaw/issues)
- [Read the architecture docs](docs/ARCHITECTURE.md)
- Originally built by [santifer](https://santifer.io), extended as Virgil by [ZRosserMcIntosh](https://github.com/ZRosserMcIntosh)
