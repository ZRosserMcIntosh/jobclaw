...
|-----------|---------------|---------------|
| **Full-Stack Engineer** | React, Next.js, Node.js, TypeScript, APIs, databases, deployment | Someone who ships complete features end-to-end, frontend to backend |
| **Frontend Engineer** | React, Next.js, TypeScript, UI/UX, component architecture, performance | Someone who builds polished, high-quality user interfaces |
| **Software Engineer** | JavaScript/TypeScript, APIs, data, web platform, problem solving | Someone who writes clean, maintainable code and delivers reliably |
| **Solutions Engineer** | Client-facing, integrations, demos, technical consulting | Someone who bridges technical and business, solves customer problems |
| **Product Engineer** | Feature ownership, user empathy, shipping, iteration, metrics | Someone who thinks like a founder — owns the problem, not just the code |
...
|-------------------|----------------------------------|---------------------|
| Full-Stack Engineer | Shipped production apps solo across e-commerce, finance, real estate. Next.js/React/Node. Founder who builds end-to-end. | cv.md (McIntosh Digital, BilionarioBrasil, Stella, SPX Toolkit) |
| Frontend Engineer | Polished UI work on Shopify/luxury e-commerce, mobile-first design, conversion-optimized layouts, component architecture | cv.md (McIntosh Digital, Stella Real Estate) |
| Software Engineer | Clean code, TypeScript/React/Node stack, API design, database work, CI/CD, self-directed delivery | cv.md (all projects) |
| Solutions Engineer | Client-facing experience with non-technical founders, translating business goals to working software, bilingual EN/PT | cv.md (Freelance experience, Caprica Capital) |
| Product Engineer | Founder mindset, owned entire product lifecycle, shipped from idea to production, user empathy from running own businesses | cv.md (Boundless Group, all projects) |
...
Frame profile as **"Founder-engineer who ships production apps solo"** that adapts framing to the role:
- For Full-Stack: "Built and shipped 4+ production web apps across e-commerce, finance, and real estate — React/Next.js/Node/TypeScript"
- For Frontend: "Designed and built conversion-optimized UIs for luxury e-commerce and real estate — mobile-first, Shopify, Next.js"
- For Software Engineer: "Self-taught engineer validated by production systems — clean code, reliable delivery, zero hand-holding"
- For Solutions Engineer: "Bilingual (EN/PT) founder who translates business goals into working software for non-technical stakeholders"
- For Product Engineer: "Founded two businesses, managed P&L, and built the tech — the definition of end-to-end ownership"

Convert "founder" into a professional signal: resourcefulness, ownership, speed, and accountability. The live production sites make this credible.

### Portfolio as Proof Point (use in high-value applications)

Live production sites the candidate built:
- **mcintoshdigital.vercel.app** — Luxury jewelry e-commerce (Shopify + custom frontend). Best for: frontend, e-commerce, UI/UX roles.
- **bilionariobrasil.com** — Full-stack financial platform. Best for: full-stack, fintech, product roles.
- **stella-real-estate.vercel.app** — Real estate platform (Next.js/Vercel). Best for: full-stack, Next.js, startup roles.
- **redentortec.com** — Tech platform. Best for: general engineering roles.

Always mention relevant live sites in applications — they are the strongest proof point.
