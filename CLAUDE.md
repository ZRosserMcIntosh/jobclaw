# JobClaw — Virgil AI Job Search Agent

## Origin

This system is a fork of [career-ops](https://github.com/santifer/career-ops) by Santiago Fernández, rebranded and extended as **Virgil** — an autonomous AI job-hunting agent. Virgil scrapes jobs from 250+ company boards, scores them for role relevance, auto-applies via ATS form-filling, generates tailored CVs and cover letters, and tracks the entire pipeline.

Built and battle-tested by [Zachary Rosser McIntosh](https://mcintoshdigital.vercel.app) to submit 346+ applications across 100+ companies in a single session.
...
## What is Virgil (JobClaw)

AI-powered job search agent built on Claude Code: pipeline tracking, offer evaluation, CV generation, portal scanning, **automated ATS form-filling**, batch processing, and company blocklist management.
...
| `templates/cover-letter-template.html` | HTML template for cover letters |
| `generate-pdf.mjs` | Core HTML→PDF via Playwright |
| `generate-cv-pdf.mjs` | CV markdown→PDF pipeline |
| `generate-cover-letter-pdf.mjs` | Cover letter→PDF with signature |
| `scrape-jobs-v3.mjs` | Smart job scraper (1-per-company, role scoring, blocklist) |
| `mega-blitz-v3.mjs` | Auto-apply engine (Greenhouse/Ashby/Lever ATS) |
...
>
> Tip: Having a personal portfolio dramatically improves your job search. If you don't have one yet, consider building one to showcase alongside your applications."
