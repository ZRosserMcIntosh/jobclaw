...
import (
	...
	"github.com/ZRosserMcIntosh/jobclaw/dashboard/internal/data"
	"github.com/ZRosserMcIntosh/jobclaw/dashboard/internal/model"
	"github.com/ZRosserMcIntosh/jobclaw/dashboard/internal/theme"
)
...
func (m PipelineModel) renderHelp() string {
	...
	brand := lipgloss.NewStyle().Foreground(m.theme.Overlay).Render("jobclaw — virgil")
